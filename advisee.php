<?php
    ...
    $result = $db->query("select * from COURSES where id=".$_SESSION["id"]);
...
<body>
        <div>
        <h1 style="margin-bottom:0;">Advisee Dashboard</h1>
        <br/>
        <center><strong><a href="login.php?lo=1" style="color:black"><font FACE="algerian">Log Out</font></a></strong></center><br/>
        <br/><br/>
        <br/>
        <opts><span
        id ="sterm"
